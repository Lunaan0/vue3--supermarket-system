...
const showAddDialog = () => {
  ...
  isEdit.value = false
  Object.assign(form, { id: null, username: '', password: '', realName: '', phone: '', status: 1, roleId: 3 })
...
const showEditDialog = (row) => {
  ...
  isEdit.value = true
  Object.assign(form, { id: row.id, username: row.username, password: '', realName: row.realName, phone: row.phone, status: row.status, roleId: 3 })
  dialogVisible.value = true
}
